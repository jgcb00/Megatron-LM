...
class SambaModel(LanguageModule):
    """Samba language model.

    Args:
        config (TransformerConfig): Transformer config
        samba_stack_spec (ModuleSpec): Specifies the modules to use for the various layer types
    ...
    def __init__(
        ...
        self.samba_stack_spec: ModuleSpec = samba_stack_spec
