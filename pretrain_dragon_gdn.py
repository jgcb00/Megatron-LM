...
from megatron.core.models.dragon_gdn.dragon_gdn_model import DragonGDNModel
...
def model_provider(pre_process=True, post_process=True) -> DragonGDNModel:
    """Builds the model.
...
def forward_step(data_iterator, model: DragonGDNModel):
